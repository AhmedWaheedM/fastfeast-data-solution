...
def wait_for_batch_folder():
    ...
    folder_name = today.strftime(config_settings.datetime_handling.date_key_format)
    ...
    end_time = start_time + timedelta(seconds=15) #test
    #end_time = start_time + config_settings.batch.timeout #prod
    ...
    while True:
        ...
        if now < start_time:
            ...
            t.sleep(min(wait_seconds, 5)) # test 
            #t.sleep(wait_seconds) #prod
            continue  
